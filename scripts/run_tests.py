...
SUITE = [
    ...
    "tests/test_openplc_behavioral.py",  # OpenPLC behavioural equivalence (skips w/o OPENPLC_HOST)
    "tests/test_fuxa_project.py",        # Phase 2/3 generated FUXA project structure
    "tests/test_fuxa_view.py",           # FUXA mimic view: SVG + readout<->tag drift guard (B1)
    ...
    "tests/test_packaging.py",           # self-contained wheel: setup.py vendoring + bootstrap (V5.5)
